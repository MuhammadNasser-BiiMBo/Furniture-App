            ...
            Stack(
              children: [
                Container(
                  ...
                  child: CachedNetworkImage(imageUrl: widget.product.img!,fit: BoxFit.fill,),
                ),
                Positioned(
                  left: 9.w,
                  top: 6.5.h,
                        ...
                        children: [
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: const Image(image: Svg(Constants.decrease)),
                            ),
                          ),
                          SizedBox(width: 5.w),
                          BigText(
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              height: 24.sp,
                              padding: EdgeInsets.all(2.sp),
                              child: const Image(image: Svg(Constants.increase)),
                            ),
                          ),
                          SizedBox(width: 4.w),
                        ],
            ...
            children: [
              Container(
                decoration: BoxDecoration(
                  ...
                  color: AppColors.appCat,
                ),
                child: Padding(
                  padding: EdgeInsets.all(14.sp),
                  child: const Image(
                    color: AppColors.appPrimary,
                    image: Svg(Constants.fav),
                  ),
                ),
              ),
              AppButton(
